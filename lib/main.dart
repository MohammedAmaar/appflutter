...
import 'package:appflutter/Constans_api/consts.dart';
...
import 'chating_page/chat_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    final List<Dashboard> dashboardData = [
      Dashboard(title: "Courses", icon: Icons.class_, bgcolor: Colors.red, onTap: (){
