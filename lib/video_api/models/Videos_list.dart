...
class VideosList {
  ...
  factory VideosList.fromJson(Map<String, dynamic> json) => VideosList(
    ...
    videos: List<Videos_Item>.from(json["items"].map((x) => Videos_Item.fromJson(x))),
...
class Videos_Item {
  ...
  factory Videos_Item.fromJson(Map<String, dynamic> json) => Videos_Item(
    kind: json["kind"],
    etag: json["etag"],
    id: json["id"],
